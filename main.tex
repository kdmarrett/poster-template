\documentclass[20pt,margin=0.5in,innermargin=-1.5in,blockverticalspace=0.25in]{tikzposter}
...
\institute{\textsuperscript{$\dagger$}Department of Computer Science, UCLA}
           % \textsuperscript{$\ddagger$}Department of Neuroscience, UCLA }
\titlegraphic{\includegraphics[width=0.20\textwidth]{cdsc.png}}
